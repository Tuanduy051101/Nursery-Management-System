<template>
  ...
  <div class="border border-solid border-slate-600 rounded-md mb-5">
    ...
    />
    <div v-if="actionPage == 2" class="border border-solid my-5 border-slate-600 border-b-0"></div>
    <ReceiptL v-if="actionPage == 2" />
    <PaymentL v-if="actionPage == 3" />
  </div>
  <FormEditTeacher
    v-if="editTeacher"
...
import ReceiptL from "../../invoice/receipt/index.vue";
import PaymentL from "../../invoice/payment/index.vue";
