    ...
    >
      ...
      <tbody>
        ...
        <tr v-if="items.length != 0" class="" >
            <td :colspan="colSpan" class="text-center pt-8 text-slate-300"><span @click="addItem" class="border border-solid border-green-900 hover:border-green-500 px-5 py-2 rounded-md cursor-pointer text-slate-600 hover:text-slate-300" >{{ nameAction }}</span></td>
        </tr>
      </tbody>
    </table>
