          ...
          <td class="p-2">
            ...
            <div class="flex justify-center">
              <IDelete
                ...
                class="material-symbols-outlined text-red-900 hover:text-red-500 hover:border-red-500 cursor-pointer flex justify-center border border-solid border-red-900 w-7 rounded-md text-lg"
              />
            </div> -->
          </td>
        </tr>
