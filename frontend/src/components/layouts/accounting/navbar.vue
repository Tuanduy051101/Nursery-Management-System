  ...
  <div class="flex flex-row items-center justify-between">
    <div class="flex items-center">
      <img
        ...
        class="ml-5"
      />
      <div class="flex space-x-8 mx-5 items-center text-slate-900 text-xl">
    ...
    <div class="flex">
      <div class="mx-10 mt-1.5">
        ...
        <div class="flex justify-end items-center -space-x-2.5">
          <a class="flex items-center group border rounded-sm">
            <span
              class="material-symbols-outlined group-hover:text-white text-slate-900 cursor-pointer"
              >notifications</span
            >
          </a>
          <div
            class="bg-red-400 rounded-full shadow-xl text-white mb-6 flex justify-center items-center pt-1"
      ...
      <div class="group relative mr-5">
        ...
        >
          ...
          <div class="ml-3 mr-2 capitalize">
            <p class="text-base font-medium text-slate-900">{{ username }}</p>
            <p class="text-xs font-medium text-slate-900">{{ role }}</p>
          </div>
        </div>
        <ul
      ...
      menus: [
        {
          _id: 1,
          name: "Dashboard",
          router: "Dashboard-accountant",
          nameUse: "Thống kê",
        },
        {
          _id: 2,
          name: "Tuition fees",
          router: "TuitionFees-accountant",
          nameUse: "Khoản thu",
        },
        {
          _id: 3,
          name: "Collection rates",
          router: "CollectionRates-accountant",
          nameUse: "Mức thu",
        },
        {
          _id: 4,
          name: "Invoice",
          router: "Invoice-accountant",
          nameUse: "Phiếu thu học phí",
        },
      ],
    };
  },
