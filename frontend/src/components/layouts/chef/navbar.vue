    ...
    <div class="flex items-center">
      ...
      <div class="flex space-x-8 mx-5 items-center text-slate-900 text-xl">
        <div v-for="(value, index) in menus" class="">
          ...
          >
            <a
              @click="(activeMenu = index + 1), sessionStorageactiveIndex(index + 1)"
              href="#"
              :class="[
                activeMenu == index + 1 ? 'text-green-500' : 'hover:text-blue-500',
              ]"
              >{{ value.nameUse }}</a
            >
          </router-link>
      ...
      <div class="mx-10 mt-1.5">
        ...
        <div class="flex justify-end items-center -space-x-2.5">
          <a class="flex items-center group border rounded-sm">
            <span
              class="material-symbols-outlined text-slate-900 cursor-pointer"
              >notifications</span
            >
          </a>
          <div
